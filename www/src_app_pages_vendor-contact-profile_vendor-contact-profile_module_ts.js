...
let VendorContactProfilePage = class VendorContactProfilePage {
    constructor(router, api, util, inituser, firestore) {
        this.router = router;
        this.api = api;
        this.util = util;
...
VendorContactProfilePage = (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([
