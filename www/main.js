...
/* harmony import */ var src_app_service_util_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! src/app/service/util.service */ 19915);
...
let AdministorAccountsPage = class AdministorAccountsPage {
  constructor(router, fireAuth, firestore, alert, loadCnt, initUser, authentication, util, api) {
    this.router = router;
  ...
  sendVendorEmail() {
    ...
    Email.send({
      ...
      alert('message sent'); // console.log(message)
    });
  }
  ...
  moveToAdd() {
    ...
    return (0,D_website_vendor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (_this2.loggedinUser.manageAdmin === 'Y') {
        _this2.addNewaccount = false;
      } else {
        _this2.addNewaccount = true;
  ...
  deleteAdmin(items) {
    ...
    return (0,D_website_vendor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this3.alertc = yield _this3.util.createAlert('', false, `Do you want to delete?`, {
        text: 'No',
        role: 'cancel',
        cssClass: 'secondary',
        handler: function () {
          var _ref3 = (0,D_website_vendor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
            yield _this3.alert.dismiss();
          });
        ...
        text: 'Yes',
        handler: function () {
          var _ref4 = (0,D_website_vendor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
            yield _this3.alert.dismiss(); //  navigator['app'].exitApp();
            // console.log(items)

            _this3.adminUser.forEach((data, index) => {
              // console.log(data, index)
              if (data.id === items.id) {
                _this3.adminUser.splice(index, 1);

                console.log(data);

                _this3.firestore.delete('admin', items.id).then( /*#__PURE__*/function () {
                  var _ref5 = (0,D_website_vendor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (use) {
                    console.log(use); // this.router.navigate(['admin/invitedvendors'])

                    const toast = yield _this3.api.createToasts('successfully deleted', false, 'middle');
                    yield toast.present();
                  });
    ...
    return (0,D_website_vendor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const alert = yield _this4.alert.create({
        ...
        buttons: [{
          ...
          cssClass: 'secondary',
          handler: function () {
            var _ref6 = (0,D_website_vendor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
              yield _this4.alert.dismiss();
            });
          ...
          text: 'Yes',
          handler: function () {
            var _ref7 = (0,D_website_vendor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
              _this4.authentication.forgotPassoword(_this4.loggedinUser.email);
        ...
        inputs: [{
          ...
          value: _this4.loggedinUser.email
        } // {
        //   type: 'number',
        //   placeholder: 'Age',
        //   min: 1,
  ...
  loading() {
    ...
    return (0,D_website_vendor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const load = yield _this5.loadCnt.create({
        message: 'sending...',
        duration: 3000,
        spinner: 'circles'
      });
...
AdministorAccountsPage.ctorParameters = () => [{
  ...
  type: src_app_service_util_service__WEBPACK_IMPORTED_MODULE_8__.UtilService
}, {
  type: src_app_service_api_service__WEBPACK_IMPORTED_MODULE_3__.ApiService
}];

AdministorAccountsPage = (0,tslib__WEBPACK_IMPORTED_MODULE_11__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_12__.Component)({
...
const routes = [
    ...
    {
        path: 'admin/addvendor',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-src_app_service_firestorage_service_ts"), __webpack_require__.e("src_app_admin_addvendor_addvendor_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./admin/addvendor/addvendor.module */ 11027)).then(m => m.AddvendorPageModule)
    },
    {
        path: 'pages/login',
    ...
    },
    {
        ...
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-src_app_service_firestorage_service_ts"), __webpack_require__.e("common"), __webpack_require__.e("src_app_admin_login-info_login-info_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./admin/login-info/login-info.module */ 45310)).then(m => m.LoginInfoPageModule)
    },
    {
...
/* harmony import */ var _angular_fire_compat__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! @angular/fire/compat */ 11879);
...
/* harmony import */ var _ionic_storage_angular__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! @ionic/storage-angular */ 47566);
/* harmony import */ var _awesome_cordova_plugins_file_opener_ngx__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @awesome-cordova-plugins/file-opener/ngx */ 99439);
/* harmony import */ var _awesome_cordova_plugins_core__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @awesome-cordova-plugins/core */ 49471);
...
AppModule = (0,tslib__WEBPACK_IMPORTED_MODULE_9__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_10__.NgModule)({
        ...
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_11__.BrowserModule, _angular_forms__WEBPACK_IMPORTED_MODULE_12__.FormsModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_13__.IonicModule.forRoot(), _app_routing_module__WEBPACK_IMPORTED_MODULE_1__.AppRoutingModule, _angular_fire_compat_auth__WEBPACK_IMPORTED_MODULE_14__.AngularFireAuthModule, _angular_common_http__WEBPACK_IMPORTED_MODULE_15__.HttpClientModule,
            _ionic_storage_angular__WEBPACK_IMPORTED_MODULE_16__.IonicStorageModule.forRoot({ name: 'admindb' }),
            _angular_fire_compat__WEBPACK_IMPORTED_MODULE_17__.AngularFireModule.initializeApp(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__.environment.Config),
        ],
        ...
        providers: [src_app_service_api_service__WEBPACK_IMPORTED_MODULE_5__.ApiService, _service_inituser_service__WEBPACK_IMPORTED_MODULE_6__.InituserService, _awesome_cordova_plugins_file_opener_ngx__WEBPACK_IMPORTED_MODULE_7__.FileOpener, _awesome_cordova_plugins_core__WEBPACK_IMPORTED_MODULE_8__.AwesomeCordovaNativePlugin,
            { provide: _angular_router__WEBPACK_IMPORTED_MODULE_18__.RouteReuseStrategy, useClass: _ionic_angular__WEBPACK_IMPORTED_MODULE_13__.IonicRouteStrategy, },
            _service_firebase_authentication_service__WEBPACK_IMPORTED_MODULE_2__.FirebaseAuthenticationService,
            { provide: _angular_core__WEBPACK_IMPORTED_MODULE_10__.APP_INITIALIZER, useFactory: InituserServiceFactory, deps: [_service_inituser_service__WEBPACK_IMPORTED_MODULE_6__.InituserService], multi: true },],
...
let ApiService = class ApiService {
  ...
  getSearchTemp(temporaryId) {
    // console.log(date)
    return this.firestore.getdate('vendorAdd', ref => ref.where('temporaryId', '==', temporaryId) // .where('first_name','<=',dates)
    );
  }

  getSearchcompname(name) {
    // console.log(date)
    return this.firestore.getdate('vendorAdd', ref => ref.where('companyname', '==', name) // .where('companyname'.toLocaleUpperCase(),'==',name)
    // .where('first_name','<=',dates)
    );
  }

  getSearchfirstName(name) {
    // console.log(date)
    return this.firestore.getdate('vendorAdd', ref => ref // .where('companyname','==',name)
    .where('first_name', '==', name) // .where('first_name'.toUpperCase(),'==',name)
    );
  }
  ...
  getAllvend() {
    // console.log(date)
    return this.firestore.getdate('vendorAdd', ref => ref // .where('companyname','==',name)
    .orderBy('createdAt', 'desc') // .orderBy('crea')
    );
  }
