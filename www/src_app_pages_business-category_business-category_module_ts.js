...
let BusinessCategoryPage = class BusinessCategoryPage {
    constructor(router, inituser, firestore, util, api) {
        this.router = router;
...
BusinessCategoryPage = (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([
