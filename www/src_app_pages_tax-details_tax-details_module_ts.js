...
let TaxDetailsPage = class TaxDetailsPage {
    constructor(router, inituser, util, firestore, api) {
        this.router = router;
    ...
    moveToTaxRec() {
        ...
        console.log(this.loggedInVendor.id, this.loggedInVendor.Tax_number, this.loggedInVendor.Tax_number_type, this.loggedInVendor.reason);
        this.fieldDetails();
    }
    select(eve) {
...
TaxDetailsPage = (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([
