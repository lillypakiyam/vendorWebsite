...
let TaxRecordPage = class TaxRecordPage {
    constructor(router, util, inituser) {
        this.router = router;
        this.util = util;
...
TaxRecordPage = (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([
