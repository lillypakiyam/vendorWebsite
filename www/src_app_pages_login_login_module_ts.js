...
let LoginPage = class LoginPage {
  constructor(router, authent, firestore, initUser, util, api) {
    this.router = router;
    ...
    this.api.logIn(this.vendorUser.email + '@gmail.com', this.vendorUser.password).subscribe(res => {
      ...
      this.api.getVendorUser().subscribe(user => {
        ...
        if (this.loggedinVendor.approved === false) {
          ...
          if (this.loggedinVendor.country !== null && this.loggedinVendor.email !== null && this.loggedinVendor.street !== null && this.loggedinVendor.house !== null && this.loggedinVendor.city !== null && this.loggedinVendor.postal_code !== null && this.loggedinVendor.ph_no !== null) {
            this.util.goToNew('pages/vendor-contact-profile');
          }

          if (this.loggedinVendor.first_name !== null && this.loggedinVendor.relationship_type !== null && this.loggedinVendor.contact_email !== null && this.loggedinVendor.ph_no !== null) {
            this.util.goToNew('pages/bank-details'); // this.util.goToNew('pages/vendor-contact-profile')
          }

          if (this.loggedinVendor.country !== null && this.loggedinVendor.Account_no !== null && this.loggedinVendor.bank_code !== null && this.loggedinVendor.currency !== null && this.loggedinVendor.street !== null && this.loggedinVendor.document !== null && this.loggedinVendor.city !== null && this.loggedinVendor.swift_bic !== null && this.loggedinVendor.bank_name !== null) {
        ...
        var _ref = (0,D_website_vend_log_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (error) {
      ...
      var _ref2 = (0,D_website_vend_log_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (error) {
        const toast = yield _this.api.createToast('please use your permenant id', false, 'middle');
        yield toast.present();
      });
