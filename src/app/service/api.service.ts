...
export class ApiService {
  ...
  getSearchTemp(temporaryId): Observable<any>{
    // console.log(date)
    return this.firestore.getdate('vendorAdd', ref => ref
  ...
  getSearchcompname(name): Observable<any>{
    // console.log(date)
    return this.firestore.getdate('vendorAdd', ref => ref
    .where('companyname','==',name) 
    // .where('companyname'.toLocaleUpperCase(),'==',name)
    // .where('first_name','<=',dates)
    );
  }

  getSearchfirstName(name): Observable<any>{
    // console.log(date)
    return this.firestore.getdate('vendorAdd', ref => ref
    // .where('companyname','==',name)
    .where('first_name','==',name)
    // .where('first_name'.toUpperCase(),'==',name)
    );
  }
